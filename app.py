...
empresas = [
    Empresa('mercadorenan@gmail.com', '1245', 'email_empr', 'senha_e    ;mpr', 'cep_empr', 'tel_empr', 'certificados_empr')
]
...
class RegistroForm(FlaskForm):
    ...
    email = StringField("email_acad", validators=[DataRequired()])
    senha = PasswordField ("senha_acad", validators=[DataRequired()])
    tel = StringField("tel_cada", validators=[DataRequired()])
